...
pub enum Error {
    ...
    InvalidLanguageLength = 32,
    InvalidThumbnailUrlLength = 33,
    InvalidDurationValue = 34,
    InvalidLimitValue = 35,
    InvalidOffsetValue = 36,
    InvalidGoalContent = 37,
    InvalidPrerequisiteId = 38,
    EmptyPrerequisiteList = 39,
    TooManyPrerequisites = 40,
    EmptyPrerequisiteId = 41,
    InvalidCourseId = 42,
    InvalidPrice100 = 30,
